    ...
    <div className={`min-h-screen bg-[var(--surface)] ${isTransitioning ? "notebook-exit" : "notebook-enter"}`}>
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="font-display text-xl font-semibold text-black mb-2">Biblioteca en camino</h3>
          <p className="text-black/60 mb-6 max-w-sm mx-auto">
            Aquí verás tu contenido publicado para revisarlo y reutilizarlo.✨
          </p>
